...
console.log('next: search the literature and add ≥ 2 new open-access entries to docs/RESEARCH.md (R23: free full text, read, linked on an "Open access:" line), edit song.js and README.md, pick tags from songs/tags.json, then node scripts/check-song.mjs');
